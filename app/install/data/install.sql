...
-- ----------------------------
-- Table structure for `ob_lifeAccount`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_account`;
CREATE TABLE `ob_life_account`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `life_type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生活号类型id',
  `life_name` varchar(255) NOT NULL DEFAULT '' COMMENT '生活号名',
  `appid` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'app id',
  `totalFans` bigint NOT NULL DEFAULT '0' COMMENT '总粉丝数',
  `merchant_private_key` LONGTEXT NOT NULL COMMENT '商户私钥',
  `alipay_public_key` LONGTEXT NOT NULL COMMENT '商户公钥',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  `icon` CHAR(30) NOT NULL DEFAULT '' COMMENT '图标',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='生活号表';
-- ----------------------------
-- Table structure for `ob_life_type`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_type`;
CREATE TABLE `ob_life_type`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `type_name` varchar(255) NOT NULL DEFAULT '' COMMENT '类型名',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='生活号类型表';
-- ----------------------------
-- Table structure for `ob_life_fan`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_fan`;
CREATE TABLE `ob_life_fan`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `life_account_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生活号id',
  `attention_status` int(10) NOT NULL DEFAULT '-1' COMMENT '关注状态(0取关 1关注)',
  `attention_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '关注时间',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='粉丝关注情况表';
-- ----------------------------
-- Table structure for `ob_life_article`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_article`;
CREATE TABLE `ob_life_article`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `life_account_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生活号id',
  `article_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文章id',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='文章和生活号中间表';
-- ----------------------------
-- Table structure for `ob_life_news`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_news`;
CREATE TABLE `ob_life_news`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `content` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '消息内容',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='消息表';
-- ----------------------------
-- Table structure for `ob_life_account_news`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_account_news`;
CREATE TABLE `ob_life_account_news`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `life_account_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生活号id',
  `new_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '消息id',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='消息和生活号中间表';
-- ----------------------------
-- Table structure for `ob_life_menu`
-- ----------------------------
DROP TABLE IF EXISTS `ob_life_menu`;
CREATE TABLE `ob_life_menu`(
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id自增',
  `life_account_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生活号id',
  `menu_name` VARCHAR(255) NOT NULL DEFAULT '' '菜单内容',
  `icon` char(30) NOT NULL DEFAULT '' COMMENT '菜单图标',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=209 DEFAULT CHARSET=utf8 COMMENT='生活号菜单表';